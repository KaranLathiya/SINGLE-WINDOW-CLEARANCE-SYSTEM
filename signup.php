...
<body bgcolor=#131724>
	<section id="sec">
		...
		<a href="Homepage.html"><img class="img" src="Images/govn2.png" align=left></a>
		...
		<div class="form-box">
			...
			<div class="containersignin">
				<center>
					<p><h6>Already have an account?: <a href="login.php">Log in</a></h6></p>
				</center>
			</div>
			</div>
			</form>
...
//   ro.value="'.$Roles.'";
  ...
  em.value="'. $Email .' ";
		...
		try {
			$query1  =  "INSERT INTO signup VALUES('$Fullname','$Email', '$Pwd')";
